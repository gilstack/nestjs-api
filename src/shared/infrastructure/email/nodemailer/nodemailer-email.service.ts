...
import type { IEmailService, EmailOptions } from '../interfaces/email.interface';
...
export class NodemailerEmailService implements IEmailService, OnModuleInit {
    ...
    async sendMagicLink(email: string, magicLinkUrl: string, expiresInMinutes: number): Promise<void> {
